...
package org.eclipse.tracecompass.internal.analysis.chromium.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.analysis.chromium.core"; //$NON-NLS-1$
